package com.elastic.poc.handler;


import com.elastic.poc.exception.ValidationFailedException;
import com.elastic.poc.exception.response.InputValidationExceptionResponse;
import com.elastic.poc.exception.response.RestExceptionResponse;
import com.elastic.poc.exception.response.MissingDataExceptionResponse;
